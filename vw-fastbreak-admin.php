<div class="wrap">  
    ...
    <form name="vw_fb_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
        ...
        <p><?php _e("Presented Date: " ); ?><input type="text" placeholder="event date" name="vw_fb_date" value="<?php echo $db_date; ?>" size="20"><?php _e(" example: 2012/12/22" ); ?></p>  
